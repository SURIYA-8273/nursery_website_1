...
// Remove props interface if not used elsewhere, or keep it optional
const HeroSection2 = () => {
  ...
  return (
    <section className="relative min-h-[calc(100vh-80px)] flex items-center justify-center overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2  md:gap-14 items-center relative z-10 w-full">
        ...
        <div className="flex justify-center mx-auto items-center relative w-full h-[350px] md:h-[600px] mt-4 lg:mt-0">

          {/* Animated Center Element */}
          <div className="-z-10">
            <div className="w-[340px] h-[320px] sm:w-[350px] sm:h-[350px] md:w-[400px] md:h-[400px] lg:w-[350px] lg:h-[350px] bg-green-600/30 rounded-[30px]" />
          </div>
