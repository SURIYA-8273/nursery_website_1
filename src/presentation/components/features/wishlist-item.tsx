...
export const WishlistItem = ({ item, viewMode }: WishlistItemProps) => {
                ...
                <div className="flex-1 flex flex-col pt-1 md:pt-2">
                    <div className="flex justify-between items-start gap-2">
                        <div className="space-y-1 min-w-0">
                            <h3 className="font-serif font-bold text-lg md:text-3xl line-clamp-1 text-[var(--color-text-primary)] leading-tight mt-1 break-words">{plant.name}</h3>
    ...
    // Grid View
    return (
        <div className="group relative bg-[var(--color-surface-hover)] rounded-[10px] overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 border border-primary/50 p-2">
            <Link href={`/plants/${plant.id}`} className="block">
                ...
                <div className="px-2 py-2">
                    ...
                    <h3 className="font-serif font-bold text-lg text-[var(--color-text-primary)]  line-clamp-1">{plant.name}</h3>
